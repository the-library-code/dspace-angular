...
@Component({
  ...
  selector: 'ds-object-list-mainpage',
  styleUrls: ['./object-list-mainpage.component.scss'],
  templateUrl: './object-list-mainpage.component.html',
  animations: [fadeIn]
})
export class ObjectListMainpageComponent {
  /**
