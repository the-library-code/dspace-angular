 ...
 */
@Component({
    selector: 'ds-viewable-collection-mainpage',
    styleUrls: ['./object-collection-mainpage.component.scss'],
    templateUrl: './object-collection-mainpage.component.html',
})
export class ObjectCollectionMainpageComponent implements OnInit {
    /**
