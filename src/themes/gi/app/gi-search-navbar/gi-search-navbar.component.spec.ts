...
describe('SearchNavbarComponent', () => {
  let component: GiSearchNavbarComponent;
  let fixture: ComponentFixture<GiSearchNavbarComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [GiSearchNavbarComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GiSearchNavbarComponent);
